...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ex.save()
        ex.tags.set(
            [Tag.objects.get(name='easy'), Tag.objects.get(name='popular')]
        )
        ex.tutorials.set([YoutubeLink.objects.all()[10]])
        ex.muscles.set(
            [Muscle.objects.get(name='pec'), Muscle.objects.get(name='tri')]
        )
        ...
        ex.save()
        ex.tutorials.set(
            [YoutubeLink.objects.all()[60], YoutubeLink.objects.all()[61]]
        )
