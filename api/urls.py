...
action_mapping = {"post": "create", "get": "list"}

urlpatterns = [
    path("exercises/", ExerciseList.as_view(action_mapping), name="exercise-list"),
    path("exercises/<int:exercise_id>", ExerciseDetail.as_view(), name="exercise-detail"),
    path("routines/", RoutineList.as_view(action_mapping), name="routine-list"),
    path("routines/<int:routine_id>", RoutineDetail.as_view(), name="routine-detail"),
    path("workouts/", WorkoutList.as_view(action_mapping), name="workout-list"),
